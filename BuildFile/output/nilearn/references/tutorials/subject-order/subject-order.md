...
```python
models, *_ = first_level_from_bids(dataset_path=str(tmp_path / bids_path), task_label='main', space_label='MNI', img_filters=[('desc', 'preproc')], slice_time_ref=0.0)
```
...
*Source: test_first_level_from_bids.py:971 | Complexity: Intermediate | Last updated: 2026-05-18*