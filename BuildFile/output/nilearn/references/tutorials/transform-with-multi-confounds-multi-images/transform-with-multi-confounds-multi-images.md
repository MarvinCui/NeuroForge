# How To: Transform With Multi Confounds Multi Images
...
Workflow: test transform with multi confounds multi images
...
### Step 5: Call parcellator.fit()

```python
parcellator.fit(fmri_imgs)
```

### Step 6: Assign signals = parcellator.transform(...)
...
*Source: test_parcellations.py:315 | Complexity: Intermediate | Last updated: 2026-05-18*