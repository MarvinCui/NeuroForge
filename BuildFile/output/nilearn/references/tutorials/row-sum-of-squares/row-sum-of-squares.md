...
Workflow: Test row_sum_of_squares.
...
### Step 1: 'Test row_sum_of_squares.'
...
### Step 5: Assign var1 = value

```python
var1 = signals ** 2
```

### Step 6: Assign var1 = var1.sum(...)

```python
var1 = var1.sum(axis=0)
```

### Step 7: Assign var2 = row_sum_of_squares(...)
...
*Source: test_signal.py:475 | Complexity: Advanced | Last updated: 2026-05-18*