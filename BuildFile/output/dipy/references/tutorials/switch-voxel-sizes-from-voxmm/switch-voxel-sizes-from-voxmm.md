# How To: Switch Voxel Sizes From Voxmm
...
Workflow: test switch voxel sizes from voxmm
...
```python
sft = load_tractogram(FILEPATH_DIX['gs_streamlines.trk'], FILEPATH_DIX['gs_volume.nii'], to_space=Space.VOXMM)
```

### Step 2: Assign sft_switch = StatefulTractogram(...)

```python
sft_switch = StatefulTractogram(sft.streamlines, FILEPATH_DIX['gs_volume_3mm.nii'], Space.VOXMM)
```
...
*Source: test_stateful_tractogram.py:110 | Complexity: Advanced | Last updated: 2026-05-18*