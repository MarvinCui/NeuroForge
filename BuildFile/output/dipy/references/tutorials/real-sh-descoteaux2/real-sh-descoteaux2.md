...
Workflow: test real sh descoteaux2
...
### Step 17: Assign unknown = real_sh_descoteaux(...)

```python
B, m_values, l_values = real_sh_descoteaux(10, sphere.theta, sphere.phi, full_basis=True)
```
...
*Source: test_shm.py:317 | Complexity: Advanced | Last updated: 2026-05-18*