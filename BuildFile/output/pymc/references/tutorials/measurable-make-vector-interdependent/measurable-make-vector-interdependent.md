# How To: Measurable Make Vector Interdependent
...
```python
np.testing.assert_allclose(logp_combined.eval({x_vv: x_vv_test, ys_vv: ys_vv_test}).sum(), ref_logp_combined.eval({x_vv: x_vv_test, y0_vv: ys_vv_test[0], y1_vv: ys_vv_test[1], y2_vv: ys_vv_test[2]}))
```
...
*Source: test_tensor.py:135 | Complexity: Advanced | Last updated: 2026-05-18*