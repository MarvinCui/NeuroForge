# How To: Parallelgaussianclassifier
...
**Verification:**
```python
assert_array_almost_equal(node.inv_covs[i], pnode.inv_covs[i], precision)
```
...
### Step 5: Assign node = mdp.nodes.GaussianClassifier(...)
...
### Step 6: Assign pnode = parallel.ParallelGaussianClassifier(...)
...
*Source: test_parallelclassifiers.py:4 | Complexity: Advanced | Last updated: 2026-05-18*