# How To: Mcmc Split Bar Starts At Zero Ends At Total
...
Workflow: test mcmc split bar starts at zero ends at total
...
### Step 6: Call orig_init()

```python
orig_init(self, *args, **kwargs)
```

### Step 7: Assign unknown = self

```python
captured['manager'] = self
```

### Step 8: Assign task = _get_task(...)
...
```python
pm.sample(draws=draws, tune=tune, chains=chains, cores=1, progressbar=True, compute_convergence_checks=False, nuts_sampler='pymc')
```
...
*Source: test_manager.py:40 | Complexity: Advanced | Last updated: 2026-05-18*