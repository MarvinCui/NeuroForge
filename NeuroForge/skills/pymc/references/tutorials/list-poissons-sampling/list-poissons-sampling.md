...
Workflow: test list poissons sampling
...
### Step 11: Assign trace = sample(...)

```python
trace = sample(5000, chains=1, step=Metropolis(), random_seed=5363567, progressbar=False, return_inferencedata=False)
```
...
*Source: test_mixture.py:486 | Complexity: Advanced | Last updated: 2026-05-18*