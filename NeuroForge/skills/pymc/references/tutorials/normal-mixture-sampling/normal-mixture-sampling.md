# How To: Normal Mixture Sampling
...
Workflow: test normal mixture sampling
...
### Step 10: Call NormalMixture()

```python
NormalMixture('x_obs', w, mu, tau=tau, observed=norm_x)
```

### Step 11: Assign step = Metropolis(...)
...
### Step 14: Assign trace = sample(...)

```python
trace = sample(5000, step=step, random_seed=20160911, progressbar=False, chains=1, return_inferencedata=False)
```
...
*Source: test_mixture.py:787 | Complexity: Advanced | Last updated: 2026-05-18*