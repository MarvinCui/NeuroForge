# bids-specification Source/Test Snippets
...
## 1. test_assignability

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/tests/test_context_types.py:14`
- Note: Workflow: Verify that dataclass values can be assigned to variables annotated with protocols. For pytest, this just checks instantiability. Running mypy with bst installed should check assignability, for example, with:: uvx --with=. mypy tests
...
- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_rules.py:8`
...
- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_validator.py:68`
...
## 4. test_dereferencing

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_schema.py:190`
...
- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_schema.py:67`
...
## 6. test_accept_non_bids_dir

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_validator.py:216`
...
## 7. test_exclude_files

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_validator.py:189`
...
## 8. test_make_sidecar_table

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_render_tables.py:56`
...
## 9. test_make_columns_table

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_render_tables.py:115`
...
## 10. test_validate_bids

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_validator.py:136`
...
## 11. test_make_glossary

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_render_text.py:38`
...
## 12. test_valid_sidecar_field

- Kind: `test-workflow`
- Source: `bids-specification/tools/schemacode/src/bidsschematools/tests/test_expressions.py:108`
