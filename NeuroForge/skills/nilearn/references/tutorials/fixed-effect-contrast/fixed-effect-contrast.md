...
Workflow: test fixed effect contrast
...
### Step 3: Assign con = compute_fixed_effect_contrast(...)

```python
con = compute_fixed_effect_contrast([labels, labels], [results, results], [c1, c2])
```
...
*Source: test_contrasts.py:99 | Complexity: Intermediate | Last updated: 2026-05-18*