# How To: Logistic Gradient At Simple Points
...
Workflow: Test gradient of logistic data loss function in points near to zero.
...
### Step 1: 'Test gradient of logistic data loss function in points near to zero.\n\n    This is a not so hard test, just for detecting big errors.\n    '
...
### Step 4: Assign w = np.append(...)

```python
w = np.append(w, 0)
```

### Step 5: Assign point = np.zeros(...)
...
def func_grad(w):
    return _logistic_data_loss_and_spatial_grad_derivative(X, y, w, mask, grad_weight)
...
*Source: test_graph_net.py:159 | Complexity: Intermediate | Last updated: 2026-05-18*