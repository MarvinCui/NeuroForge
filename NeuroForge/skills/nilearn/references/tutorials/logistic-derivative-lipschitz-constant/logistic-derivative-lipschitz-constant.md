# How To: Logistic Derivative Lipschitz Constant
...
Workflow: Test Lipschitz-continuity of the derivative of logistic loss.
...
### Step 1: 'Test Lipschitz-continuity of the derivative of logistic loss.'
...
### Step 4: Assign lipschitz_constant = _logistic_derivative_lipschitz_constant(...)

```python
lipschitz_constant = _logistic_derivative_lipschitz_constant(X, mask, grad_weight)
```
...
```python
gradient_difference = linalg.norm(_logistic_data_loss_and_spatial_grad_derivative(X, y, x_1, mask, grad_weight) - _logistic_data_loss_and_spatial_grad_derivative(X, y, x_2, mask, grad_weight))
```
...
*Source: test_graph_net.py:213 | Complexity: Advanced | Last updated: 2026-05-18*