# How To: Multi Nifti Maps Masker Resampling To Mask
...
Workflow: Test resampling to mask in MultiNiftiMapsMasker.
...
### Step 1: 'Test resampling to mask in MultiNiftiMapsMasker.'
...
```python
masker = MultiNiftiMapsMasker(maps33_img, mask_img=mask22_img, resampling_target='mask', keep_masked_maps=True, standardize=None)
```
...
*Source: test_multi_nifti_maps_masker.py:259 | Complexity: Advanced | Last updated: 2026-05-18*