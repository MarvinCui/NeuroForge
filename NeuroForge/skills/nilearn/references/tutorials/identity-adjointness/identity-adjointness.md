...
Workflow: Test adjointess between _graph_net_data_function and     _graph_net_adjoint_data_function, with identity design matrix.
...
### Step 1: 'Test adjointess between _graph_net_data_function and     _graph_net_adjoint_data_function, with identity design matrix.\n    '

```python
'Test adjointess between _graph_net_data_function and     _graph_net_adjoint_data_function, with identity design matrix.\n    '
```
...
### Step 5: Assign n_samples = np.sum(...)

```python
n_samples = np.sum(mask)
```

### Step 6: Assign X = np.eye(...)
...
*Source: test_graph_net.py:88 | Complexity: Advanced | Last updated: 2026-05-18*