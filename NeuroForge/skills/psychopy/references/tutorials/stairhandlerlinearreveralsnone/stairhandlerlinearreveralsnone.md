# How To: Stairhandlerlinearreveralsnone
...
Workflow: test StairHandlerLinearReveralsNone
...
```python
self.intensities = [0.8, 0.7, 0.6, 0.5, 0.4, 0.41, 0.42, 0.43, 0.44, 0.44, 0.44, 0.439, 0.439, 0.44, 0.441, 0.442, 0.443, 0.443, 0.443, 0.442]
```
...
*Source: test_StairHandlers.py:253 | Complexity: Advanced | Last updated: 2026-05-18*