# mne-python Source/Test Snippets
...
## 1. test_plot_evoked_field_notebook

- Kind: `test-workflow`
- Source: `mne-python/mne/viz/tests/test_3d.py:242`
...
## 2. test_xdawn_decoding_performance

- Kind: `test-workflow`
- Source: `mne-python/mne/preprocessing/tests/test_xdawn.py:352`
...
## 3. test_morph_stc_sparse

- Kind: `test-workflow`
- Source: `mne-python/mne/tests/test_morph.py:831`
...
- Kind: `test-workflow`
- Source: `mne-python/mne/time_frequency/tests/test_tfr.py:981`
...
## 5. test_source_psd_epochs

- Kind: `test-workflow`
- Source: `mne-python/mne/minimum_norm/tests/test_time_frequency.py:341`
...
## 6. test_make_forward_solution_sphere

- Kind: `test-workflow`
- Source: `mne-python/mne/forward/tests/test_make_forward.py:539`
...
- Kind: `test-workflow`
- Source: `mne-python/mne/preprocessing/tests/test_maxwell.py:1088`
...
- Kind: `test-workflow`
- Source: `mne-python/mne/utils/tests/test_check.py:387`
...
- Kind: `test-workflow`
- Source: `mne-python/mne/viz/tests/test_evoked.py:628`
...
## 10. test_plot_volume_source_estimates_morph

- Kind: `test-workflow`
- Source: `mne-python/mne/viz/tests/test_3d_mpl.py:113`
...
## 11. test_simulate_sparse_stc

- Kind: `test-workflow`
- Source: `mne-python/mne/simulation/tests/test_source.py:124`
...
- Kind: `test-workflow`
- Source: `mne-python/mne/tests/test_filter.py:803`
