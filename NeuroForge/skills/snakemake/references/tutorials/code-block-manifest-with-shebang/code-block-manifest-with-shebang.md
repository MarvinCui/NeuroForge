# How To: Code Block Manifest With Shebang
...
Workflow: test code block manifest with shebang
...
```python
expected_manifest = dedent('//! This is a regular crate doc comment, but it also contains a partial\n//! Cargo manifest.  Note the use of a *fenced* code block, and the\n//! `cargo` "language".\n//!\n//! ```cargo\n//! [dependencies]\n//! time = "0.1.25"\n//! ```\n')
```
...
*Source: test_script.py:279 | Complexity: Intermediate | Last updated: 2026-05-18*