...
Workflow: test rb no verbose and mam
...
```python
rec_trans, rec_labels = rb.recognize(model_bundle=f2, model_clust_thr=5.0, reduction_thr=10, slr=True, pruning_distance='mam')
```
...
*Source: test_bundles.py:129 | Complexity: Advanced | Last updated: 2026-05-18*