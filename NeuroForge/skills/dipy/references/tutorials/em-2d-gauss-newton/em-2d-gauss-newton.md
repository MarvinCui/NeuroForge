...
Workflow: Test 2D SyN with EM metric, Gauss-Newton optimizer
...
### Step 1: 'Test 2D SyN with EM metric, Gauss-Newton optimizer\n\n    Register a coronal slice from a T1w brain MRI before and after warping\n    it under a synthetic invertible map. We verify that the final\n    registration is of good quality.\n    '
...
### Step 12: Assign iter_type = 'gauss_newton'
...
*Source: test_imwarp.py:920 | Complexity: Advanced | Last updated: 2026-05-18*