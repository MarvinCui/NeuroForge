...
Workflow: test transform origins 3d
...
### Step 16: Assign c_moving = value

```python
c_moving = moving_grid2world[:3, 3]
```

### Step 17: Assign expected = np.eye(...)
...
### Step 19: Assign actual = imaffine.transform_origins(...)

```python
actual = imaffine.transform_origins(static, static_grid2world, moving, moving_grid2world)
```
...
*Source: test_imaffine.py:158 | Complexity: Advanced | Last updated: 2026-05-18*