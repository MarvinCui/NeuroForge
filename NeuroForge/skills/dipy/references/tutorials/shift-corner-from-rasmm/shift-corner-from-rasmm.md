# How To: Shift Corner From Rasmm
...
Workflow: test shift corner from rasmm
...
```python
sft_2 = load_tractogram(FILEPATH_DIX['gs_streamlines.trk'], FILEPATH_DIX['gs_volume.nii'], to_space=Space.RASMM)
```
...
*Source: test_stateful_tractogram.py:328 | Complexity: Advanced | Last updated: 2026-05-18*