...
Workflow: test real sh descoteaux1
...
### Step 9: Assign unknown = real_sym_sh_mrtrix(...)

```python
basis, m_values, l_values = real_sym_sh_mrtrix(4, sphere.theta, sphere.phi)
```

### Step 10: Assign unknown = real_sh_descoteaux(...)

```python
descoteaux07_basis, m_values, l_values = real_sh_descoteaux(4, sphere.theta, sphere.phi)
```
...
*Source: test_shm.py:258 | Complexity: Advanced | Last updated: 2026-05-18*