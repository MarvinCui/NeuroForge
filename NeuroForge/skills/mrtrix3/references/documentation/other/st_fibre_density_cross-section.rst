...
Perform group DWI intensity normalisation::
    ...
    dwinormalise group ../dwinormalise/dwi_input/ ../dwinormalise/mask_input/ ../dwinormalise/dwi_skills/ ../dwinormalise/fa_template.mif ../dwinormalise/fa_template_wm_mask.mif

Link the output files back to the subject directories::

    for_each ../dwinormalise/dwi_skills/* : ln -sr IN PRE/dwi_denoised_unringed_preproc_unbiased_normalised.mif
